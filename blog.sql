...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 28 2023 г., 11:32
...
CREATE TABLE `users` (
  ...
  `grants` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(1, 'nikita', 'nik1', 'nik@mail.ru', '12345678', 'admin'),
(2, 'denis', 'den0', 'den@mail.ru', '', 'moderator');
